...
function App() {
  ...
  return (
    <div className="container  mt-5 mb-5 ms-5 me-5 p-5">
      <h2 className="m-2" style={{ color: "red", textAlign: "center" }}>
      ...
      >
        {userDetails ? (
         ...
         <button style={{ width: "200px", height: "50px", borderRadius:"20px",textAlign:"center"}}  onClick={handleRandomUserClick}>Random User</button>
      </div>
    </div>
  );
}
